...
let tabs = {
  ...
  settings: { active: false, name: 'Settings', component: ActivityTab, props: {} }
}
...
describe('<TabPills />', () => {
  it('renders a tab pill', () => {
    const wrapper = shallow(<TabPills tabs={tabs} handleEnableTab={handleEnableTab} />);
  ...
  it('second tab is active', () => {
    tabs = {
      ...
      timeline: { active: true, name: 'Timeline', component: ActivityTab, props: {} },
      settings: { active: false, name: 'Settings', component: ActivityTab, props: {} }
    }
    const wrapper = shallow(<TabPills tabs={tabs} handleEnableTab={handleEnableTab} />);
